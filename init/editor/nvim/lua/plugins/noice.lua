...
return {
    ...
    dependencies = {
        ...
        --    If not available, we use `mini` as the fallback
        {
            ...
            --  enabled = false, --  trying to disable lsp warnings
        },
    },
    --  module = "nui",
    --  module = "noice",
        ...
        require("noice").setup({
            ...
            lsp = {
                ...
                hover = {
                    ...
                    silent  = true, --  trying to disable lsp warnings
                    view    = nil,  --  when nil, use defaults from documentation
                ...
                message = {
                    ...
                    --   enabled = true,
                    --  "Check log for errors:" comes from:
                    --  /usr/share/nvim/runtime/lua/vim/lsp.lua:function on_client_exit(code, signal, client_id)
                    enabled = false, --  trying to disable lsp warnings
                    view    = "notify",
                    opts    = {
                        --  anchor = "SE",
            ...
            views = {
                ...
                scrollbar = false,
                hover = {
                    scrollbar = false, --  github issues #603
                },
                --  input = input,
                cmdline = {
                    scrollbar  = false,
