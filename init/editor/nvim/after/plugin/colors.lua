...
hl(0, 'Normal',                 { bg='NONE' })
-- When cursor on a word, other similar word highlight by "Visual"
...
if vim.o.background == 'dark' then
	...
	-- hl(0, 'CursorLine',         { fg = 'White', bg = 'Black', blend = 80, nocombine = true })
	hl(0, 'CursorLine',         { fg = 'White', bg = 'NONE', blend = 80, nocombine = true })
...
hl(0, 'Whitespace',             { bg = 'NONE',    fg = 'NONE' })
...
hl(0, 'IndentBlanklineSpaceChar', { fg = 'White',    bg = 'Magenta' })
hl(0, 'IndentBlanklineSpaceCharBlankline', { fg = 'White',    bg = 'Magenta' })
...
hl(0, 'diffLine',               { bg = 'Brown',   fg = 'White' })
hl(0, 'diffAdded',              { bg = 'Teal',    fg = 'White' })
-- g=#80a0ff gui=bold
-- Extmarksf gui=bold
